...
var defaultTokenizer = function (text) {
  //remove punctuation from text - remove anything that isn't a word char or a space
   var rgxPunctuation =''
 ///[^(a-zA-ZA-Яa-я0-9_)+\s]/g

   var khar = typeof(text)
 ...
 */
Naivebayes.prototype.categorize = function (text,threshold) {
  var normalize = 0
  ...
  var p = 1-(maxProbability/normalize)
  if (chosenCategory == 'spam' & p<(threshold/100))
  {
    chosenCategory = 'ham'
  }
...
Naivebayes.prototype.toJson = function () {
  ...
  var file = './data.json'
  jsonfile.writeFile(file, jsonStr, function (err) {
  //console.error(err)
  })
...
//console.log(JSON.stringify(finalljson))

var jsonStr1 = JSON.stringify(finalljson)
